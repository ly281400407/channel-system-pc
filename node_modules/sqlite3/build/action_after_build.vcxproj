...
<Project DefaultTargets="Build" ToolsVersion="14.0" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup Label="Globals">
    <ProjectGuid>{DC3D22E1-6D32-FD7B-BC68-B7F6933999D9}</ProjectGuid>
  ...
  <ItemGroup>
    <CustomBuild Include="$(OutDir)\node_sqlite3.node">
      ...
      <Command>call mkdir &quot;D:\Electron\myDestopApp\node_modules\sqlite3\lib\binding\electron-v1.7-win32-x64&quot; 2&gt;nul &amp; set ERRORLEVEL=0 &amp; copy /Y &quot;$(OutDir)node_sqlite3.node&quot; &quot;D:\Electron\myDestopApp\node_modules\sqlite3\lib\binding\electron-v1.7-win32-x64\node_sqlite3.node&quot;&#xD;&#xA;if %errorlevel% neq 0 exit /b %errorlevel%</Command>
      <Message>Copying $(OutDir)/node_sqlite3.node to D:/Electron/myDestopApp/node_modules/sqlite3/lib/binding/electron-v1.7-win32-x64\node_sqlite3.node</Message>
      <Outputs>D:\Electron\myDestopApp\node_modules\sqlite3\lib\binding\electron-v1.7-win32-x64\node_sqlite3.node</Outputs>
    </CustomBuild>
  </ItemGroup>
  <ItemGroup>
    <ProjectReference Include="node_sqlite3.vcxproj">
      <Project>{32A55A46-3FA8-063D-A4A6-2AAA5030BAFF}</Project>
