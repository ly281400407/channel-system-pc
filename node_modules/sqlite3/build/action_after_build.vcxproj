...
<Project DefaultTargets="Build" ToolsVersion="14.0" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup Label="Globals">
    <ProjectGuid>{9B745BBF-8F97-6438-193A-CB86CBD29C89}</ProjectGuid>
  ...
  <ItemGroup>
    <CustomBuild Include="$(OutDir)\node_sqlite3.node">
      ...
      <Command>call mkdir &quot;C:\Git\channel-system-pc\node_modules\sqlite3\lib\binding\electron-v1.7-win32-x64&quot; 2&gt;nul &amp; set ERRORLEVEL=0 &amp; copy /Y &quot;$(OutDir)node_sqlite3.node&quot; &quot;C:\Git\channel-system-pc\node_modules\sqlite3\lib\binding\electron-v1.7-win32-x64\node_sqlite3.node&quot;&#xD;&#xA;if %errorlevel% neq 0 exit /b %errorlevel%</Command>
      <Message>Copying $(OutDir)/node_sqlite3.node to C:/Git/channel-system-pc/node_modules/sqlite3/lib/binding/electron-v1.7-win32-x64\node_sqlite3.node</Message>
      <Outputs>C:\Git\channel-system-pc\node_modules\sqlite3\lib\binding\electron-v1.7-win32-x64\node_sqlite3.node</Outputs>
    </CustomBuild>
  </ItemGroup>
  <ItemGroup>
    <ProjectReference Include="node_sqlite3.vcxproj">
      <Project>{0AEE78B8-1114-D860-0B7C-2C5B93B4D954}</Project>
